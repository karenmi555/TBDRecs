...
import { BookOpen, Film, Tv, UtensilsCrossed, BedDouble, Sparkles, Trash2, Users, ArrowLeft, MapPin } from 'lucide-react';
...
const categoryIcon = (cat: string) => {
  ...
  if (cat === 'other') return <Sparkles className="w-3.5 h-3.5" />;
